...
M.get = function(colors, opts)
    ...
    return {
        ...
        FoldColumn                  = { fg = colors.gray, bg = opts.transparent_mode and colors.none or colors.bg1 },
        SignColumn                  = { bg = opts.transparent_mode and colors.none or colors.bg1 },
        ...
        Normal                      = { fg = colors.fg1, bg = opts.transparent_mode and colors.none or colors.bg0 },
        ...
        NormalNC                    = { fg = colors.fg1, bg = opts.transparent_mode and colors.none or opts.dim_inactive and colors.bg1 or colors.bg0 },
